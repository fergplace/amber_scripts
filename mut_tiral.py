...
def check_input(args):
    ...
    name_from, name_to, idx = option.split(':')
    ...
    return (fh, name_from, name_to, idx)


def run(fhandle, name_from, name_to, idx):
    """
...
def main():
    # Check Input
    pdbfh, name_from, name_to, idx = check_input(sys.argv[1:])

    # Do the job
    new_pdb = run(pdbfh, name_from, name_to, idx)
